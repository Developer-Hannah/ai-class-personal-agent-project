...
* **PRD** – what the agent does, its tools, and the problem it solves.
...
## Deliverables
1.  **GitHub repo** with proper infrastructure and incremental history.
2.  **Working agent** – three tools + memory + web UI.
3.  **`README.md`**.
4.  **2-minute demo video** – an unedited screen capture showing your agent's web UI in action with a couple of its tools/features. Doesn't need to be polished.
